...
namespace RealTime.Patches
{
    ...
    internal static class TouristAIPatch
    {
        ...
        [HarmonyPrefix]
        private static bool UpdateLocationPrefix(TouristAI __instance, uint citizenID, ref Citizen data)
        {
        ...
        [HarmonyPrefix]
        private static bool SetTargetPrefix(ushort instanceID, ref CitizenInstance data, ushort targetIndex, bool targetIsNode)
        {
        ...
        [HarmonyPrefix]
        private static bool StartTransferPrefix(TouristAI __instance, uint citizenID, ref Citizen data, TransferManager.TransferReason material, TransferManager.TransferOffer offer)
        {
        ...
        [HarmonyPrefix]
        private static bool GetColorPrefix(TouristAI __instance, ushort instanceID, ref CitizenInstance data, InfoManager.InfoMode infoMode, InfoManager.SubInfoMode subInfoMode, ref Color __result)
        {
            if (instanceID == 0)
            {
                return true;
