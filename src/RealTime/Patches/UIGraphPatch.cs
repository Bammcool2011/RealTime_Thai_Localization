...
namespace RealTime.Patches
{
    ...
    internal static class UIGraphPatch
    {
        ...
        public static void Translate(CultureInfo cultureInfo) => currentCulture = cultureInfo ?? throw new ArgumentNullException(nameof(cultureInfo));
        ...
        [HarmonyPrefix]
        private static bool GetMinDataPointsPrefix(List<CurveSettings> ___m_Curves, DateTime ___m_StartTime, DateTime ___m_EndTime, ref int __result)
        {
        ...
        [HarmonyPrefix]
        private static bool GetVisibleEndTimePrefix(List<CurveSettings> ___m_Curves, DateTime ___m_StartTime, DateTime ___m_EndTime, ref DateTime __result)
        {
        ...
        [HarmonyPostfix]
        private static void BuildLabelsPostfix(UIGraph __instance, PoolList<Vector3> vertices, PoolList<int> indices, PoolList<Vector2> uvs, PoolList<Color32> colors, ref List<CurveSettings> ___m_Curves, ref Rect ___m_GraphRect, ref PoolList<UIRenderData> ___m_RenderData)
        {
